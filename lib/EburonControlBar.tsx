  ...
  React.useEffect(() => {
    ...
    try {
      ...
      const updateLevel = () => {
        ...
        // Add some smoothing to avoid jitter
        const smoothedLevel = audioLevel * 0.7 + normalizedLevel * 0.3;
          ...
          <div className={styles.audioSplitControl}>
            ...
            <div className={`${styles.audioSplitSection} ${styles.audioSplitLeft}`} ref={micMenuRef}>
              ...
              >
                ...
                {/* Audio Visualizer - Enhanced animation when speaking */}
                {isMicEnabled && (
                  <div 
                    ...
                    {[0, 1, 2, 3, 4, 5].map((i) => (
                      <div
                        ...
                        style={{
                          width: '1.5px',
                          height: audioLevel > 2 
                            ? `${Math.max(3, Math.min(8, audioLevel * (0.3 + i * 0.15)))}px` 
                            : '1px',
                          backgroundColor: audioLevel > 2 
                            ? `rgba(76, 175, 80, ${0.8 + i * 0.04})` 
                            : 'rgba(255, 255, 255, 0.2)',
                          borderRadius: '0.5px',
                          transition: 'height 0.05s ease-out, background-color 0.05s ease-out',
                          minHeight: '1px',
                          boxShadow: audioLevel > 5 
                            ? `0 0 ${2 + i}px rgba(76, 175, 80, ${0.3 + i * 0.1})` 
                            : 'none'
                        }}
                      />
                    ))}
